...
function [h, hFill] = plotWithErr(xdata, ydata, errBars, color)
...
% negative value)
    ...
    hFill = fill([xdata xdata(end:-1:1)], [ydata+errBars ydata(end:-1:1)-errBars(end:-1:1)], color, 'FaceAlpha', 0.5, 'EdgeAlpha', 0);
